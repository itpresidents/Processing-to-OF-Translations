...
/* 
 Original Created 26 Sept. 2005
 by Tom Igoe
 modified 30 Aug 2011
 by Tom Igoe and Scott Fitzgerald
 
 translation from processing-> openFrameworks. Lia Martinez 2012
 */

//--------------------------------------------------------------
void testApp::setup(){
	
	ofSetWindowShape(256, 256);
	ofSetFrameRate(60); //Processing default
	ofBackground(0);
	...
	//serial.setup("/dev/tty.usbserial-A4001JEC",9600); // you can also do this
}

//--------------------------------------------------------------
void testApp::update(){
	
	unsigned char inByte = serial.readByte();
	//printf(" inByte %i \n ", inByte);
